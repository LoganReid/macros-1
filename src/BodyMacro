...
'
    ...
    With ActiveDocument.PageSetup.TextColumns
        ...
        .LineBetween = False
    End With
    ActiveDocument.PageSetup.TextColumns.Add Width:=InchesToPoints(2.26), _
        Spacing:=InchesToPoints(1.23), EvenlySpaced:=False
    Selection.WholeStory
    Selection.WholeStory
    With ActiveDocument.Styles(wdStyleNormal).Font
        If .NameFarEast = .NameAscii Then
    ...
    With ActiveDocument.PageSetup.TextColumns
        ...
        .LineBetween = False
    End With
    ActiveDocument.PageSetup.TextColumns.Add Width:=InchesToPoints(3.26), _
        Spacing:=InchesToPoints(0.74), EvenlySpaced:=False
    Selection.WholeStory
End Sub
Sub Macro2()
'
